...
public class IntersectCalculator {
    ...
    /*
     See if two line segments intersect. This uses the vector cross product approach described below: http://stackoverflow.com/a/565282/786339

     @param {Object} p point object with x and y coordinates representing the start of the 1st line.
     @param {Object} p2 point object with x and y coordinates representing the end of the 1st line.
     @param {Object} q point object with x and y coordinates representing the start of the 2nd line.
     @param {Object} q2 point object with x and y coordinates representing the end of the 2nd line.
    */
